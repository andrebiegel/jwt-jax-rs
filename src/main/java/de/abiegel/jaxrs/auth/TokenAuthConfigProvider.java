...
public class TokenAuthConfigProvider implements AuthConfigProvider {
   ...
   * @param factory
   */
  public TokenAuthConfigProvider(Map<String, String> properties,
	...
	public TokenAuthConfigProvider() {
	...
	public ServerAuthConfig getServerAuthConfig(String layer, String appContext, CallbackHandler handler)
			throws AuthException {
	    return new TokenServerAuthConfig(layer, appContext,
