 ...
 * 
 */
public class TokenServerAuthContext implements ServerAuthContext {

	private ServerAuthModule serverAuthModule;

	public TokenServerAuthContext(CallbackHandler handler) throws AuthException {
		serverAuthModule = new TokenServerAuthModule();
